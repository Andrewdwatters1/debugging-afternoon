...
import { removeFromShoppingCart, getAllProducts } from '../../redux/reducer';
...
export default connect(mapStateToProps, {getAllProducts, removeFromShoppingCart})(ShoppingCart);